...
$data = $db->select('nguoi_dung','*',$condition,$limit);
...
$cc_text = $cung_cap[$row['quyen']];
  $records["aaData"][] = array(
      ...
      $row['sdt'],
      $cc_text,
      '<a href="home.php?page=user_action&action=edit&id='.$row['id'].'" class="btn btn-xs default btn-editable"><i class="fa fa-pencil"></i>Sửa</a>
      <a onclick="return confirm(\'Bạn chắc chắn xóa?\')" href="home.php?page=user_action&action=del&id='.$row['id'].'" class="btn btn-xs default btn-editable"><i class="fa fa-times"></i>Xóa</a>',
    );
}
